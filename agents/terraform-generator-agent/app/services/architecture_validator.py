...
def validate_architecture(architecture: NormalizedArchitecture) -> ArchitectureValidation:
    ...
    for resource in architecture.resources:
        if resource.provider_type not in {
            ...
            "aws_cloudwatch_log_group", "aws_lambda_function", "aws_lambda_permission",
            "aws_lambda_event_source_mapping", "aws_apigatewayv2_api", "aws_apigatewayv2_stage",
            "aws_apigatewayv2_integration", "aws_apigatewayv2_route", "aws_dynamodb_table", "aws_sqs_queue",
            "aws_cognito_user_pool", "aws_cognito_user_pool_client", "aws_lb_listener_rule",
            "aws_s3_bucket_public_access_block", "aws_s3_bucket_server_side_encryption_configuration",
            "aws_s3_bucket_notification", "aws_s3_bucket_lifecycle_configuration",
            "aws_s3_bucket_cors_configuration", "aws_iam_role_policy", "aws_eip",
