    ...
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="border-b border-border px-6 py-4 bg-background">
        <div className="flex items-start justify-between gap-4 mb-4">
          <div>
            <h1 className="text-2xl font-bold text-foreground">{architecture.title}</h1>
      ...
      <Tabs defaultValue="overview" className="flex-1 overflow-hidden flex flex-col">
        <TabsList className="w-full justify-start border-b border-border bg-background px-6 rounded-none h-auto p-0">
          <TabsTrigger value="overview" className="rounded-none border-b-2 border-transparent">
            Overview
          </TabsTrigger>
          <TabsTrigger value="diagram" className="rounded-none border-b-2 border-transparent">
            Diagram
          </TabsTrigger>
          <TabsTrigger value="components" className="rounded-none border-b-2 border-transparent">
            Components
          </TabsTrigger>
          <TabsTrigger value="decisions" className="rounded-none border-b-2 border-transparent">
            Decisions
          </TabsTrigger>
          <TabsTrigger value="report" className="rounded-none border-b-2 border-transparent">
            Report
          </TabsTrigger>
          <TabsTrigger value="specification" className="rounded-none border-b-2 border-transparent">
            Specification
          </TabsTrigger>
        </TabsList>
